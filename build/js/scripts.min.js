...
!(function (t, e) {
  ...
  function t(e, t) {
    var i,
      ...
      e = new e(t);
    try {
      i = new CustomEvent(s, { detail: { instance: e } });
    } catch (t) {
  ...
  var o = "undefined" != typeof window,
    ...
    P = o && "IntersectionObserver" in window,
    i = o && "classList" in document.createElement("p"),
    H = {
      elements_selector: "img",
      container: n || o ? document : null,
      threshold: 300,
      thresholds: null,
      data_src: "src",
      data_srcset: "srcset",
  ...
  function s(t, e, i) {
    (e = m + e), null === i ? t.removeAttribute(e) : t.setAttribute(e, i);
  }
  function r(t, e) {
    (t.loadingCount += e),
      0 === t._elements.length &&
        0 === t.loadingCount &&
        T(t._settings.callback_finish, t);
  }
  function l(t) {
  ...
  function a(t, e) {
    $(t, "sizes", w(t, e.data_sizes)),
      $(t, "srcset", w(t, e.data_srcset)),
      $(t, "src", w(t, e.data_src));
  }
  function d(t, e) {
    i
  ...
  function h(t, e, i) {
    u(t, _, e), u(t, k, e), u(t, E, i);
  }
  function p(t, e, i) {
    var s = i._settings,
      o = e ? s.class_loaded : s.class_error,
      e = e ? s.callback_loaded : s.callback_error,
      t = t.target;
    d(t, s.class_loading), I(t, o), T(e, t, i), r(i, -1);
  }
  function G(t, e) {
  ...
  function g(t, e, i) {
    var s = e._settings;
    (!i && S(t)) ||
      (-1 < B.indexOf(t.tagName) && (N(t, e), I(t, s.class_loading)),
      F(t, e),
      j(t),
      T(s.callback_reveal, t, e),
      T(s.callback_set, t, e));
  }
  function f(t, e) {
    return (
      (t = t || e.container.querySelectorAll(e.elements_selector)),
  ...
  function e(t, e) {
    var i, s;
    (this._settings = _extends({}, H, t)),
      (this.loadingCount = 0),
      (i = this),
      P &&
        (i._observer = new IntersectionObserver(function (t) {
          t.forEach(function (t) {
            return (W(t) ? R : U)(t.target, t, i);
          });
        }, Y(i._settings))),
      this.update(e),
      (s = this),
  ...
  var m = "data-",
    ...
    T = function (t, e, i, s) {
      t && (void 0 !== s ? t(e, i, s) : void 0 !== i ? t(e, i) : t(e));
    },
    $ = function (t, e, i) {
    ...
    F = function (t, e) {
      ...
      (t = w((e = t), (o = s).data_src)),
        (o = w(e, o.data_bg)),
        t && (e.style.backgroundImage = 'url("'.concat(t, '")')),
    ...
    N = function (i, s) {
      ...
      (n = o), c((t = i), _, (e = r)), c(t, k, e), c(t, E, n);
    },
    B = ["IMG", "IFRAME", "VIDEO"],
    R = function (t, e, i) {
      var s = i._settings;
      T(s.callback_enter, t, e, i), (s.load_delay ? G : A)(t, i);
    },
    A = function (t, e) {
      var i = e._observer;
    ...
    U = function (t, e, i) {
      var s = i._settings;
      T(s.callback_exit, t, e, i), s.load_delay && O(t);
    },
    O = function (t) {
      var e = x(t);
  ...
  if (
            ...
            : (s.use_native &&
                ...
                ((e = this)._elements.forEach(function (t) {
                  -1 !== V.indexOf(t.tagName) &&
                    (t.setAttribute("loading", "lazy"), g(t, e));
                }),
                (this._elements = f(t, s))),
    ...
    if (D)
      if (D.length) for (var z, M = 0; (z = D[M]); M += 1) t(L, z);
      else t(L, D);
  }
  return e;
}),
      ...
      return function (o, t) {
        function e(t) {
          if (
            ...
            "closest" in t.target &&
            (n = t.target.closest(o)) &&
            "a" === n.tagName.toLowerCase() &&
            !t.target.closest(m.ignore) &&
            n.hostname === w.location.hostname &&
            n.pathname === w.location.pathname &&
            /#/.test(n.href)
          ) {
            var e;
            try {
              i = r(decodeURIComponent(n.hash));
            } catch (t) {
              i = r(n.hash);
            }
            if ("#" === i) {
            ...
            (e = e || "#top" !== i ? e : document.documentElement) &&
              (t.preventDefault(),
              (i = m),
        ...
        var m,
          ...
          b = {
            cancelScroll: function (t) {
              cancelAnimationFrame(v), (v = null), t || T("scrollCancel", m);
            },
          };
        b.animateScroll = function (s, o, t) {
          b.cancelScroll();
          var n,
            r,
            l,
            ...
            t = f || !s.tagName ? null : s;
          (f || t) &&
            ((n = w.pageYOffset),
            g.header && !y && (y = document.querySelector(g.header)),
            (e = (e = y)
              ? parseInt(w.getComputedStyle(e).height, 10) + e.offsetTop
              : 0),
            (a = f
              ? s
              : (function (t, e, i, s) {
                  ...
                  return (
                    (o = Math.max(o - e - i, 0)),
                    (o = s ? Math.min(o, C() - w.innerHeight) : o)
                  );
                })(
                  t,
                  e,
                  parseInt(
                    "function" == typeof g.offset ? g.offset(s, o) : g.offset,
                    10
                  ),
                  g.clip
                )),
            ...
            (p = function (t) {
              ...
              (u += t - (r = r || t)),
                (l =
                  n +
                  d *
                    ((i = l = 1 < (l = 0 === h ? 0 : u / h) ? 1 : l),
                    "easeInQuad" === g.easing && (e = i * i),
                    "easeOutQuad" === g.easing && (e = i * (2 - i)),
                    "easeInOutQuad" === g.easing &&
                      (e = i < 0.5 ? 2 * i * i : (4 - 2 * i) * i - 1),
                    "easeInCubic" === g.easing && (e = i * i * i),
                    "easeOutCubic" === g.easing && (e = --i * i * i + 1),
                    "easeInOutCubic" === g.easing &&
                      (e =
                        i < 0.5
                          ? 4 * i * i * i
                          : (i - 1) * (2 * i - 2) * (2 * i - 2) + 1),
                    "easeInQuart" === g.easing && (e = i * i * i * i),
                    "easeOutQuart" === g.easing && (e = 1 - --i * i * i * i),
                    "easeInOutQuart" === g.easing &&
                      (e =
                        i < 0.5 ? 8 * i * i * i * i : 1 - 8 * --i * i * i * i),
                    "easeInQuint" === g.easing && (e = i * i * i * i * i),
                    "easeOutQuint" === g.easing &&
                      (e = 1 + --i * i * i * i * i),
                    "easeInOutQuint" === g.easing &&
                      (e =
                        i < 0.5
                          ? 16 * i * i * i * i * i
                          : 1 + 16 * --i * i * i * i * i),
                    (e = g.customEasing ? g.customEasing(i) : e) || i)),
                w.scrollTo(0, Math.floor(l)),
                (e = a),
                (i = w.pageYOffset),
                (!(l == e || i == e || (n < e && w.innerHeight + i) >= c) ||
                  (b.cancelScroll(!0),
                  x(s, e, f),
                  T("scrollStop", g, s, o),
                  (v = r = null))) &&
                  ((v = w.requestAnimationFrame(p)), (r = t));
            }),
            ...
            f ||
              (history.pushState &&
                g.updateURL &&
                history.pushState(
                  { smoothScroll: JSON.stringify(g), anchor: t.id },
                  document.title,
        ...
        if (
          ...
          return (
            b.destroy(),
            (m = S($, t || {})),
            (y = m.header ? document.querySelector(m.header) : null),
            document.addEventListener("click", e, !1),
            m.updateURL && m.popstate && w.addEventListener("popstate", i, !1),
            b
          );
  ...
  (function (i) {
    ...
    ((c =
      e && e.fn && e.fn.select2 && e.fn.select2.amd ? e.fn.select2.amd : c) &&
      c.requirejs) ||
      (c ? (i = c) : (c = {}),
      (f = {}),
      (m = {}),
      ...
      (n = function (t, e, i, s) {
        ...
        if ("undefined" == c || "function" == c) {
          for (
            ...
            if ("require" === (n = (r = p(e[l], u)).f)) d[l] = g.require(t);
            else if ("exports" === n) (d[l] = g.exports(t)), (a = !0);
            else if ("module" === n) o = d[l] = g.module(t);
            else if (w(f, n) || w(m, n) || w(v, n)) d[l] = C(n);
            else {
              if (!r.p) throw new Error(t + " missing " + n);
              r.p.load(
                r.n,
                S(s, !0),
                (function (e) {
          ...
          (c = i ? i.apply(f[t], d) : void 0),
            t &&
              (o && o.exports !== h && o.exports !== f[t]
                ? (f[t] = o.exports)
                : (c === h && a) || (f[t] = c));
        } else t && (f[t] = i);
      }),
      (t =
        ...
        r =
          function (t, e, i, s, o) {
            if ("string" == typeof t) return g[t] ? g[t](e) : C(p(t, x(e)).f);
            if (!t.splice) {
      ...
      ((l = function (t, e, i) {
        ...
        e.splice || ((i = e), (e = [])),
          w(f, t) || w(m, t) || (m[t] = [t, e, i]);
      }).amd = { jQuery: !0 }),
      (c.requirejs = t),
      (c.require = i),
      (c.define = l)),
      c.define("almond", function () {}),
      c.define("jquery", [], function () {
        var t = e || $;
        return (
          null == t &&
            console &&
      ...
      c.define("select2/utils", ["jquery"], function (n) {
        var s = {};
        function d(t) {
          var e,
            i = t.prototype,
            s = [];
          for (e in i)
            "function" == typeof i[e] && "constructor" !== e && s.push(e);
          return s;
        }
        function t() {
          this.listeners = {};
        ...
        (s.Extend = function (t, e) {
          ...
          (s.Decorate = function (s, o) {
            ...
            function n() {
              ...
              0 < e &&
                (t.call(arguments, s.prototype.constructor),
            ...
            for (var l = 0; l < t.length; l++) {
              ...
              n.prototype[a] = (function (t) {
                var e = function () {},
                  i =
                    (t in n.prototype && (e = n.prototype[t]), o.prototype[t]);
                return function () {
                  return (
            ...
            for (var e in t) {
              ...
              if (1 !== i.length) {
                for (var o = 0; o < i.length; o++) {
                  var n = i[o];
                  (n = n.substring(0, 1).toLowerCase() + n.substring(1)) in s ||
                    (s[n] = {}),
                    o == i.length - 1 && (s[n] = t[e]),
                    (s = s[n]);
                }
                delete t[e];
              }
        ...
        return (
          ...
          (s.StoreData = function (t, e, i) {
            (t = s.GetUniqueElementId(t)),
              s.__cache[t] || (s.__cache[t] = {}),
              (s.__cache[t][e] = i);
          }),
          (s.GetData = function (t, e) {
            var i = s.GetUniqueElementId(t);
            return e
              ? s.__cache[i] && null != s.__cache[i][e]
                ? s.__cache[i][e]
                : n(t).data(e)
              : s.__cache[i];
          }),
          ...
          (s.copyNonInternalCssClasses = function (t, e) {
      ...
      c.define("select2/results", ["jquery", "./utils"], function (u, h) {
        function s(t, e, i) {
          (this.$element = t),
            (this.data = i),
            (this.options = e),
        ...
        return (
          ...
          (s.prototype.option = function (t) {
            ...
            e.classList.add("select2-results__option"),
              e.classList.add("select2-results__option--selectable");
            var i,
              s = { role: "option" },
              o =
            ...
            for (i in (((null != t.element && o.call(t.element, ":disabled")) ||
              (null == t.element && t.disabled)) &&
              ((s["aria-disabled"] = "true"),
              e.classList.remove("select2-results__option--selectable"),
              e.classList.add("select2-results__option--disabled")),
            null == t.id &&
              e.classList.remove("select2-results__option--selectable"),
            ...
            t.children &&
              ...
              (s["aria-label"] = t.text),
              e.classList.remove("select2-results__option--selectable"),
              e.classList.add("select2-results__option--group")),
            s)) {
              var n = s[i];
              e.setAttribute(i, n);
            }
            if (t.children) {
              ...
              (l.className = "select2-results__group"), this.template(t, l);
              for (var a = [], d = 0; d < t.children.length; d++) {
                var c = t.children[d],
                  c = this.option(c);
                a.push(c);
              }
            ...
            this.$results.attr("id", i),
              ...
              e.on("results:previous", function () {
                ...
                s <= 0 ||
                  ((t = s - 1),
                  0 === e.length && (t = 0),
                  (s = i.eq(t)).trigger("mouseenter"),
                  (e = o.$results.offset().top),
                  (i = s.offset().top),
                  (s = o.$results.scrollTop() + (i - e)),
                  0 === t
                    ? o.$results.scrollTop(0)
                    : i - e < 0 && o.$results.scrollTop(s));
              }),
                ...
                function (t) {
                  ...
                  e.hasClass("select2-results__option--selected")
                    ? o.options.get("multiple")
                      ...
                      : o.trigger("close", {})
                    : o.trigger("select", { originalEvent: t, data: i });
                }
              ),
              this.$results.on(
                "mouseenter",
                ...
                function (t) {
                  ...
                  o
                    ...
                    o.trigger("results:focus", { data: e, element: u(this) });
                }
              );
          }),
            ...
            (n.prototype._attachCloseHandler = function (t) {
              i(document.body).on("mousedown.select2." + t.id, function (t) {
                ...
                i(".select2.select2-container--open").each(function () {
                  this != e[0] && s.GetData(this, "element").select2("close");
                });
              });
            }),
              ...
              if ((this.clear(), 0 !== t.length)) {
                for (
                  ...
                  var o = t[s],
                    ...
                    r = this.display(o, n),
                    l = i + d.generateChars(4) + "-",
                    a =
                      (o.id ? (l += o.id) : (l += d.generateChars(4)),
                      n
                  ...
                  a && n.attr("title", a),
                    ...
                    (a = n.find(".select2-selection__choice__remove")).attr(
                      "title",
                      r()
                    ),
                    a.attr("aria-label", r()),
                    a.attr("aria-describedby", l),
                    d.StoreData(n[0], "data", o),
                    e.push(n);
                }
      ...
      c.define("select2/selection/placeholder", [], function () {
        function t(t, e, i) {
        ...
        return (
          (t.prototype.normalizePlaceholder = function (t, e) {
            return "string" == typeof e ? { id: "", text: e } : e;
          }),
          ...
          return (
            ...
            (t.prototype._handleClear = function (t, e) {
              if (!this.isDisabled()) {
                ...
                if (0 !== i.length) {
                  e.stopPropagation();
                  var s = l.GetData(i[0], "data"),
                    o = this.$element.val(),
                    n = (this.$element.val(this.placeholder.id), { data: s });
                  if ((this.trigger("clear", n), n.prevented))
                    this.$element.val(o);
                  else {
            ...
            (t.prototype._handleKeyboardClear = function (t, e, i) {
              i.isOpen() ||
                (e.which != s.DELETE && e.which != s.BACKSPACE) ||
                this._handleClear(e);
            }),
            (t.prototype.update = function (t, e) {
              var i, s;
          ...
          return (
            ...
            (t.prototype.bind = function (t, e, i) {
              var s = this,
                ...
                n = e.id + "-container";
              t.call(this, e, i),
                s.$search.attr("aria-describedby", n),
                e.on("open", function () {
                ...
                e.on("results:focus", function (t) {
                  t.data._resultId
                    ? s.$search.attr("aria-activedescendant", t.data._resultId)
                    : s.$search.removeAttr("aria-activedescendant");
                }),
                this.$selection.on(
                  "focusin",
                      ...
                      t.which === a.BACKSPACE &&
                        ...
                        0 <
                          (e = s.$selection
                            ...
                            .last()).length &&
                        ((e = l.GetData(e[0], "data")),
                        s.searchRemoveChoice(e),
                        t.preventDefault());
                  }
                ),
                this.$selection.on(
              ...
              var r = (e = document.documentMode) && e <= 11;
              this.$selection.on(
                "input.searchcheck",
                ".select2-search--inline",
                function (t) {
      ...
      c.define("select2/selection/selectionCss", ["../utils"], function (i) {
        function t() {}
        return (
          (t.prototype.render = function (t) {
            var e = t.call(this);
            return (
              -1 !==
                ...
                ((t = t.replace(":all:", "")),
                i.copyNonInternalCssClasses(e[0], this.$element[0])),
              e.addClass(t),
              e
            );
          }),
      ...
      c.define("select2/selection/eventRelay", ["jquery"], function (r) {
        function t() {}
        return (
          (t.prototype.bind = function (t, e, i) {
            var s = this,
      ...
      c.define("select2/translation", ["jquery", "require"], function (e, i) {
        function s(t) {
          this.dict = t || {};
        }
        return (
          ...
          (s.loadPath = function (t) {
            var e;
            return (
              t in s._cache || ((e = i(t)), (s._cache[t] = e)),
              new s(s._cache[t])
            );
          }),
          s
      ...
      c.define("select2/data/base", ["../utils"], function (i) {
        function s(t, e) {
          s.__super__.constructor.call(this);
        }
        return (
          ...
          return (
            ...
            (i.prototype.option = function (t) {
              ...
              return (
                ...
                t.title && (e.title = t.title),
                ((t = this._normalizeItem(t)).element = e),
                l.StoreData(e, "data", t),
                a(e)
              );
            }),
            (i.prototype.item = function (t) {
              var e = {};
              if (null != (e = l.GetData(t[0], "data"))) return e;
              var i = t[0];
      ...
      c.define(
        ...
        function (t, e, d) {
          ...
          return (
            e.Extend(s, t),
            (s.prototype.bind = function (t, e) {
              s.__super__.bind.call(this, t, e),
            ...
            (s.prototype.convertToOptions = function (t) {
              for (
                ...
                0 <= s.indexOf(a.id)
                  ...
                  : ((l = this.option(a)),
                    a.children &&
                      ((a = this.convertToOptions(a.children)), l.append(a)),
                    o.push(l));
              }
              return o;
            }),
              ...
              return n.extend(
                {},
                {
                  ...
                  transport: function (t, e, i) {
                    return (t = n.ajax(t)).then(e), t.fail(i), t;
                  },
                },
                t,
                !0
                ...
                o =
                  (null != this._request &&
                    ("function" == typeof this._request.abort &&
                      this._request.abort(),
                    (this._request = null)),
                  n.extend({ type: "GET" }, this.ajaxOptions));
              function t() {
                var t = o.transport(
                  o,
                  function (t) {
      ...
      c.define("select2/data/tags", ["jquery"], function (e) {
        function t(t, e, i) {
          ...
          if (
            ...
            void 0 !== (o = i.get("insertTag")) && (this.insertTag = o),
            t.call(this, e, i),
            Array.isArray(s))
          )
        ...
        return (
          (t.prototype.query = function (t, d, c) {
            var u = this;
            this._removeOldTags(),
              null != d.term && null == d.page
                ? t.call(this, d, function t(e, i) {
                    for (var s = e.results, o = 0; o < s.length; o++) {
                      var n = s[o],
                        r =
                          null != n.children && !t({ results: n.children }, !0);
                      if (
                        (n.text || "").toUpperCase() ===
                          (d.term || "").toUpperCase() ||
                        r
                      )
                        return !i && ((e.data = s), void c(e));
                    }
                    if (i) return !0;
                    var l,
                      a = u.createTag(d);
                    null != a &&
                      ((l = u.option(a)).attr("data-select2-tag", "true"),
                      u.addOptions([l]),
                      u.insertTag(s, a)),
                      (e.results = s),
                      c(e);
      ...
      c.define("select2/data/tokenizer", ["jquery"], function (d) {
        function t(t, e, i) {
        ...
        return (
              ...
              o =
                ...
                this.tokenizer(e, this.options, function (t) {
                  ...
                  s.$element.find("option").filter(function () {
                    ...
                    ((e = s.option(i)).attr("data-select2-tag", !0),
                    s._removeOldTags(),
                    s.addOptions([e])),
                    s.trigger("select", { data: (e = i) });
                }));
            o.term !== e.term &&
              (this.$search.length &&
          ...
          (t.prototype.tokenizer = function (t, e, i, s) {
            for (
              ...
              -1 !== o.indexOf(a)
                ? ((a = n.substr(0, r)),
                  null != (a = l(d.extend({}, e, { term: a })))
                    ? (s(a), (n = n.substr(r + 1) || ""), (r = 0))
                    : r++)
                : r++;
            }
            return { term: n };
      ...
      c.define("select2/dropdown/search", ["jquery"], function (n) {
        function t() {}
        return (
          (t.prototype.render = function (t) {
            var e = t.call(this),
          ...
          (t.prototype.bind = function (t, e, i) {
            ...
            t.call(this, e, i),
              ...
              e.on("focus", function () {
                e.isOpen() || s.$search.trigger("focus");
              }),
              e.on("results:all", function (t) {
      ...
      c.define("select2/dropdown/infiniteScroll", ["jquery"], function (i) {
        function t(t, e, i, s) {
          (this.lastParams = {}),
            t.call(this, e, i, s),
        ...
        function (c, r) {
          ...
          return (
              ...
              t.call(this, e, i),
                e.on("open", function () {
                  s._showDropdown(),
                    ...
                    s._bindContainerResultHandlers(e);
                }),
                e.on("close", function () {
            ...
            (t.prototype._attachPositioningHandler = function (t, e) {
              ...
              (e = this.$container.parents().filter(r.hasScroll)).each(
                function () {
            ...
            (t.prototype._positionDropdown = function () {
              var t = c(window),
                ...
                r =
                  ((n.top = o.top),
                  (n.bottom = o.top + n.height),
                  this.$dropdown.outerHeight(!1)),
                l = t.scrollTop(),
                a = t.scrollTop() + t.height(),
                d = l < o.top - r,
                t = a > o.bottom + r,
                l = { left: o.left, top: n.bottom };
              "static" === (a = this.$dropdownParent).css("position") &&
                (a = a.offsetParent()),
                (o = { top: 0, left: 0 }),
                (c.contains(document.body, a[0]) || a[0].isConnected) &&
                  (o = a.offset()),
                (l.top -= o.top),
                (l.left -= o.left),
                e || i || (s = "below"),
                t || !d || e ? !d && t && e && (s = "below") : (s = "above"),
                ("above" == s || (e && "below" !== s)) &&
                  (l.top = n.top - o.top - r),
                null != s &&
      ...
      c.define("select2/dropdown/selectOnClose", ["../utils"], function (s) {
        function t() {}
        return (
          (t.prototype.bind = function (t, e, i) {
            var s = this;
      ...
      c.define("select2/dropdown/dropdownCss", ["../utils"], function (i) {
        function t() {}
        return (
          (t.prototype.render = function (t) {
            var e = t.call(this);
            ...
            (t.prototype.highlightFirstItem = function (t) {
              if (
                ...
                var e,
                  i = e.first();
                if (
                  (e = s.GetData(i[0], "data").element) &&
                  e.getAttribute &&
                  "true" === e.getAttribute("data-select2-tag")
                )
        ...
        function (
          ...
          return (
            (i.prototype.apply = function (t) {
              var e;
              null == (t = a.extend(!0, {}, this.defaults, t)).dataAdapter &&
                (null != t.ajax
                  ? (t.dataAdapter = v)
                  : null != t.data
                  ? (t.dataAdapter = y)
                ...
                0 < t.minimumInputLength &&
                  (t.dataAdapter = g.Decorate(t.dataAdapter, S)),
                0 < t.maximumInputLength &&
                  (t.dataAdapter = g.Decorate(t.dataAdapter, C)),
                0 < t.maximumSelectionLength &&
                  (t.dataAdapter = g.Decorate(t.dataAdapter, x)),
                t.tags && (t.dataAdapter = g.Decorate(t.dataAdapter, b)),
                (null == t.tokenSeparators && null == t.tokenizer) ||
                  (t.dataAdapter = g.Decorate(t.dataAdapter, w))),
                null == t.resultsAdapter &&
                  ((t.resultsAdapter = n),
                  null != t.ajax &&
                    (t.resultsAdapter = g.Decorate(t.resultsAdapter, _)),
                  null != t.placeholder &&
                    (t.resultsAdapter = g.Decorate(t.resultsAdapter, I)),
                  t.selectOnClose &&
                    (t.resultsAdapter = g.Decorate(t.resultsAdapter, A)),
                  t.tags &&
                    (t.resultsAdapter = g.Decorate(t.resultsAdapter, D))),
                null == t.dropdownAdapter &&
                  (t.multiple
                    ? (t.dropdownAdapter = T)
                    : ((e = g.Decorate(T, $)), (t.dropdownAdapter = e)),
                  0 !== t.minimumResultsForSearch &&
                    (t.dropdownAdapter = g.Decorate(t.dropdownAdapter, E)),
                  t.closeOnSelect &&
                    (t.dropdownAdapter = g.Decorate(t.dropdownAdapter, O)),
                  null != t.dropdownCssClass &&
                    (t.dropdownAdapter = g.Decorate(t.dropdownAdapter, L)),
                  (t.dropdownAdapter = g.Decorate(t.dropdownAdapter, k))),
                null == t.selectionAdapter &&
                  (t.multiple
                    ? (t.selectionAdapter = l)
                    : (t.selectionAdapter = r),
                  null != t.placeholder &&
                    (t.selectionAdapter = g.Decorate(t.selectionAdapter, d)),
                  t.allowClear &&
                    (t.selectionAdapter = g.Decorate(t.selectionAdapter, c)),
                  t.multiple &&
                    (t.selectionAdapter = g.Decorate(t.selectionAdapter, u)),
                  null != t.selectionCssClass &&
                    (t.selectionAdapter = g.Decorate(t.selectionAdapter, h)),
                  (t.selectionAdapter = g.Decorate(t.selectionAdapter, p))),
                (t.language = this._resolveLanguage(t.language)),
                t.language.push("en");
              for (var i = [], s = 0; s < t.language.length; s++) {
                var o = t.language[s];
              ...
              this.defaults = {
                ...
                matcher: function t(e, i) {
                  ...
                  if (i.children && 0 < i.children.length) {
                    for (
                      var s = a.extend(!0, {}, i), o = i.children.length - 1;
                      0 <= o;
                      o--
                    )
                      null == t(e, i.children[o]) && s.children.splice(o, 1);
                    return 0 < s.children.length ? s : t(e, s);
                  }
                  var n = l(i.text).toUpperCase(),
                    r = l(e.term).toUpperCase();
            ...
            (i.prototype._resolveLanguage = function (t) {
              if (!t) return [];
              if (a.isEmptyObject(t)) return [];
              if (a.isPlainObject(t)) return [t];
              for (
                var e, i = Array.isArray(t) ? t : [t], s = [], o = 0;
                o < i.length;
                o++
              )
                s.push(i[o]),
                  "string" == typeof i[o] &&
                    0 < i[o].indexOf("-") &&
                    ((e = i[o].split("-")[0]), s.push(e));
              return s;
            }),
            (i.prototype._processTranslations = function (t, e) {
              for (var i = new f(), s = 0; s < t.length; s++) {
                var o = new f(),
                  n = t[s];
                if ("string" == typeof n)
                  try {
                ...
                else o = a.isPlainObject(n) ? new f(n) : n;
                i.extend(o);
              }
              return i;
            }),
              ...
              var e = ["select2"],
                i =
                  ...
                  c.GetData(t[0], "select2Tags") &&
                    ...
                    c.StoreData(t[0], "data", c.GetData(t[0], "select2Tags")),
                    c.StoreData(t[0], "tags", !0)),
                  c.GetData(t[0], "ajaxUrl") &&
                    (this.options.debug &&
                      window.console &&
                      console.warn &&
                      console.warn(
                    ...
                    t.attr("ajax--url", c.GetData(t[0], "ajaxUrl")),
                    c.StoreData(t[0], "ajax-Url", c.GetData(t[0], "ajaxUrl"))),
                  {});
              function s(t, e) {
                return e.toUpperCase();
              }
              for (var o = 0; o < t[0].attributes.length; o++) {
                var n = t[0].attributes[o].name,
                  r = "data-";
                n.substr(0, r.length) == r &&
                  ((n = n.substring(r.length)),
                  (r = c.GetData(t[0], n)),
                  (i[n.replace(/-([a-z])/g, s)] = r));
              }
              d.fn.jquery &&
                "1." == d.fn.jquery.substr(0, 2) &&
                t[0].dataset &&
                (i = d.extend(!0, {}, t[0].dataset, i));
              var l,
                a = d.extend(!0, {}, c.GetData(t[0]), i);
              for (l in (a = c._convertData(a)))
                -1 < e.indexOf(l) ||
                  (d.isPlainObject(this.options[l])
                    ? d.extend(this.options[l], a[l])
                    : (this.options[l] = a[l]));
              return this;
            }),
        ...
        function (e, o, n, s) {
          ...
          return (
            ...
            (r.prototype._resolveWidth = function (t, e) {
              ...
              for (var o = t.split(";"), n = 0, r = o.length; n < r; n += 1) {
                var l = o[n].replace(/\s/g, "").match(s);
            ...
            (r.prototype.trigger = function (t, e) {
              ...
              if (
                (void 0 === e && (e = {}), t in s) &&
                (i.call(this, s[t], (s = { prevented: !1, name: t, args: e })),
                s.prevented)
              )
      ...
      c.define("jquery-mousewheel", ["jquery"], function (t) {
        return t;
      }),
      c.define(
        "jquery.select2",
    ...
    var t,
      ...
      o,
      b,
      l = { define: c.define, require: c.require };
    function w(t, e) {
      return s.call(t, e);
    }
    function a(t, e) {
      ...
      if (t) {
        for (
          e = (t = t.split("/")).length - 1,
            y.nodeIdCompat && b.test(t[e]) && (t[e] = t[e].replace(b, "")),
            "." === t[0].charAt(0) &&
              h &&
      ...
      if ((h || g) && p) {
        for (d = (i = t.split("/")).length; 0 < d; --d) {
          if (((s = i.slice(0, d).join("/")), h))
            for (c = h.length; 0 < c; --c)
              if ((o = (o = p[h.slice(0, c).join("/")]) && o[s])) {
                (n = o), (r = d);
                break;
              }
          if (n) break;
    ...
    function C(t) {
      var e;
      if (
        (w(m, t) && ((e = m[t]), delete m[t], (v[t] = !0), n.apply(h, e)),
        w(f, t) || w(v, t))
      )
        return f[t];
    ...
    var c = l.require("jquery.select2");
    return (e.fn.select2.amd = l), c;
  }),
  (function (t, e) {
    ...
    var w = "lgAfterAppendSlide",
      i = "lgInit",
      S = "lgHasVideo",
      s = "lgContainerResize",
      o = "lgUpdateSlides",
      n = "lgAfterAppendSubHtml",
      a = "lgBeforeOpen",
      d = "lgAfterOpen",
      l = "lgSlideItemLoad",
      h = "lgBeforeSlide",
    ...
    (T.generateUUID = function () {
      ...
      (T.prototype.find = function (t) {
        return $(this._getSelector(t, this.selector));
      }),
      ...
      (T.prototype.on = function (t, e) {
        ...
        return (
          this.selector &&
            t.split(" ").forEach(function (t) {
              Array.isArray(T.eventListeners[t]) || (T.eventListeners[t] = []),
                T.eventListeners[t].push(e),
    ...
    var _ = function (t, e, i, s) {
      ...
      k = function (t, e, i, s, o) {
        if (o) {
          ...
          if (t.get())
            return (
              (l = (a = e.get().getBoundingClientRect()).width),
              (e = e.height() - (i + s)),
              (s = t.width()),
              (n = t.height()),
              (r = t.style()),
              (l =
                ...
                (parseFloat(r.borderLeft) || 0) +
                $(window).scrollLeft() +
                a.left),
              (a =
                (e - n) / 2 -
                t.offset().top +
                (parseFloat(r.paddingTop) || 0) +
                (parseFloat(r.borderTop) || 0) +
                $(window).scrollTop() +
                i),
              "translate3d(" +
                (l *= -1) +
      ...
      A = function (t, e, i, s, o, n) {
        ...
        return (
          (s = n
            ? ("string" == typeof n ? JSON.parse(n) : n).map(function (e) {
                var i = "";
                return (
          ...
          [].forEach.call(t, function (t) {
            for (var e = {}, i = 0; i < t.attributes.length; i++) {
              ...
              n.specified &&
                ...
                (o = ""),
                (o = -1 < h.indexOf(s) ? s : o) && (e[o] = n.value));
            }
            var r = $(t),
              l = r.find("img").first().attr("alt"),
              a = r.attr("title"),
              r = c ? r.attr(c) : r.find("img").first().attr("src");
            (e.thumb = r),
      ...
      j =
        ...
        (t.prototype.buildStructure = function () {
          ...
          (this.$container && this.$container.get()) ||
            ...
            (l = this.settings.ariaLabelledby
            ...
            (o =
              this.settings.closable && this.settings.showCloseIcon
                ...
                : ""),
            (n = this.settings.showMaximizeIcon
              ? '<button type="button" aria-label="' +
            ...
            (r =
              ...
              "\n                </div>\n            </div>\n        </div>\n        "),
            $(this.settings.container).append(r),
        ...
        (t.prototype.openGallery = function (e, t) {
          ...
          void 0 === e && (e = this.settings.index),
            this.lgOpened ||
              ...
              (r = this.galleryItems[e].__slideVideoInfo),
              this.zoomFromOrigin &&
                t &&
                ((this.currentImageSize = _(
                  t,
                  this.outer,
                  o + n,
                  r && this.settings.videoMaxSize
                )),
                (s = k(t, this.outer, o, n, this.currentImageSize))),
        ...
        (t.prototype.getDummyImageContent = function (t, e, i) {
          if ((s = this.settings.dynamic ? s : $(this.items).eq(e))) {
            e = void 0;
            if (
        ...
        (t.prototype.triggerSlideItemLoad = function (t, e, i, s, o) {
          var n = this,
            ...
            r = o && "video" === this.getSlideType(r) && !r.poster ? s : 0;
          setTimeout(function () {
            t.addClass("lg-complete lg-complete_"),
              n.LGel.trigger(l, { index: e, delay: i || 0, isFirstSlide: o });
          }, r);
        }),
        ...
        (t.prototype.addSlideVideoInfo = function (t) {
          ...
          t.forEach(function (t, e) {
            (t.__slideVideoInfo = G(t.src, !!t.video, e)),
              t.__slideVideoInfo &&
        ...
        (t.prototype.loadContent = function (e, t) {
          var i,
            ...
            g =
              (r.responsive && ((f = r.responsive.split(",")), (h = O(f) || h)),
              r.__slideVideoInfo),
            f = "",
            m = !!r.iframe,
            y = !this.lGalleryOn,
            ...
            b =
              ...
              l.hasClass("lg-loaded") ||
                (g &&
                  ((o = (i = this.mediaContainerPosition).top),
                  (i = i.bottom),
                  (o = _(
                    this.items[e],
                    this.outer,
                ...
                m
                  ...
                  ? ((i = ""),
                    y &&
                      this.zoomFromOrigin &&
                      this.currentImageSize &&
                      (i = this.getDummyImageContent(l, e, "")),
                    (s = D(a, i || "", f, this.settings.strings.playVideo, g)),
                    l.prepend(s))
                  : g
                  ? l.prepend(
                      (s =
                  ...
                  : (this.setImgMarkup(h, l, e),
                    (d || u) &&
                      ((o = l.find(".lg-object")), this.initPictureFill(o))),
                (a || g) &&
                  this.LGel.trigger(S, {
                    index: e,
                    src: h,
                ...
                this.lGalleryOn &&
                  ...
                  this.addHtml(e)),
              0);
          v && !$(document.body).hasClass("lg-from-hash") && (b = v),
              ...
              l.hasClass("lg-loaded") ||
                setTimeout(function () {
                  ...
                  "image" === n.getSlideType(r) &&
                    ((t = (t = r.alt) ? 'alt="' + t + '"' : ""),
                    l.find(".lg-img-wrap").append(A(e, h, t, d, c, r.sources)),
                    (d || u) &&
                      ((t = l.find(".lg-object")), n.initPictureFill(t))),
                    ("image" === n.getSlideType(r) ||
                      ("video" === n.getSlideType(r) && a)) &&
                      (n.onLgObjectLoad(l, e, v, b, !0, !1),
                      n.onSlideObjectLoad(
                        l,
                        !(!g || !g.html5 || a),
                        function () {
                          n.loadContentOnFirstSlideLoad(e, l, b);
                        },
                        function () {
                          n.loadContentOnFirstSlideLoad(e, l, b);
                        }
            ...
            (this.isFirstSlideWithZoomAnimation() &&
              ...
              this.onLgObjectLoad(l, e, v, b, y, !(!g || !g.html5 || a)),
            (this.zoomFromOrigin && this.currentImageSize) ||
        ...
        (t.prototype.slide = function (t, e, i, s) {
          ...
          (this.currentItemsInDom = this.organizeSlideItems(t, u)),
            (this.lGalleryOn && u === t) ||
              ((o = this.galleryItems.length),
              this.lgBusy ||
                (this.settings.counter && this.updateCurrentCounter(t),
                (n = this.getSlideItem(t)),
                (r = this.getSlideItem(u)),
                (d = (a = this.galleryItems[t]).__slideVideoInfo),
            ...
            t &&
              ...
              "horizontal" === this.swipeDirection
                ? (null != i && i.preventDefault(),
                  ...
                  this.setTranslate(t, n, 0),
                  (s =
                    (15 * (o = t.get().offsetWidth)) / 100 -
                    Math.abs((10 * n) / 100)),
                  this.setTranslate(
                ...
                : "vertical" === this.swipeDirection &&
                  ...
                  (o = 1 - Math.abs(e) / window.innerHeight),
                  this.$backdrop.css("opacity", o),
                  (n = 1 - Math.abs(e) / (2 * window.innerWidth)),
                  this.setTranslate(t, 0, e, n, n),
                  100 < Math.abs(e) &&
                    this.outer
            ...
            setTimeout(function () {
              ...
              r.outer.find(".lg-item").removeAttr("style"),
                t &&
                  ...
                  ((e = $(o.target)),
                  r.isPosterElement(e) && r.LGel.trigger(c)),
            ...
            this.$inner.on("touchend.lg", function (t) {
              "swipe" === i.touchAction &&
                (o
                  ...
                  : n &&
                    ((t = $(t.target)),
                    i.isPosterElement(t) && i.LGel.trigger(c)),
        ...
        (t.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            ...
            $(window).on("mousemove.lg.global" + this.lgId, function (t) {
              n &&
                i.lgOpened &&
                ((r = !0),
            ...
            $(window).on("mouseup.lg.global" + this.lgId, function (t) {
              var e;
              i.lgOpened &&
                ((e = $(t.target)),
                r
                  ? ((r = !1), i.touchEnd(o, s, t), i.LGel.trigger(f))
                  : i.isPosterElement(e) && i.LGel.trigger(c),
                n &&
                  ((n = !1),
          ...
          var i,
            ...
            r =
              (this.zoomFromOrigin &&
                ...
                (s = s.bottom),
                (o = (r = this.galleryItems[this.index]).__slideVideoInfo),
                (r = r.poster),
                (o = _(
                  t,
                  this.outer,
                  i + s,
                  o && r && this.settings.videoMaxSize
                )),
                (n = k(t, this.outer, i, s, o))),
  ...
  (function (t, e) {
      ...
      r =
        ...
        (a.prototype.on = function (t, e) {
          ...
          return (
            this.selector &&
              t.split(" ").forEach(function (t) {
                Array.isArray(a.eventListeners[t]) ||
                  (a.eventListeners[t] = []),
    ...
    var u = 0,
      h =
        ...
        (t.prototype.buildStructure = function () {
          ...
          (this.$container && this.$container.get()) ||
            ...
            (r =
              ...
              (".lg-sub-html" === this.settings.appendSubHtmlTo ? e : "") +
              "\n                </div>\n            </div>\n        </div>\n        "),
            x(this.settings.container).append(r),
            document.body !== this.settings.container &&
          ...
          return (
            ...
            this.settings.dynamic
              ...
              : ("this" === this.settings.selector
                  ...
                  ? "string" == typeof this.settings.selector
                    ? this.settings.selectWithin
                      ? ((t = x(this.settings.selectWithin)),
                        (this.items = t.find(this.settings.selector).get()))
                      : (this.items = this.el.querySelectorAll(
                          this.settings.selector
                        ))
          ...
          void 0 === e && (e = this.settings.index),
            this.lgOpened ||
              ...
              this.zoomFromOrigin &&
                ...
                (s = d(t, this.outer, o, n, this.currentImageSize))),
              (this.zoomFromOrigin && s) ||
                (this.outer.addClass(this.settings.startClass),
                this.getSlideItem(e).removeClass("lg-complete")),
              (r = this.settings.zoomFromOrigin
        ...
        (t.prototype.getDummyImageContent = function (t, e, i) {
          if ((s = this.settings.dynamic ? s : x(this.items).eq(e))) {
            if (
              !(e = this.settings.exThumbImage
                ? s.attr(this.settings.exThumbImage)
                : s.find("img").first().attr("src"))
        ...
        (t.prototype.onSlideObjectLoad = function (t, e, i, s) {
          var o,
            t = t.find(".lg-object").first();
          (!!(o = t.get()) && !!o.complete && 0 !== o.naturalWidth) || e
            ? i()
            : (t.on("load.lg error.lg", function () {
                i && i();
              }),
          ...
          var i,
            ...
            C =
              ...
              c.hasClass("lg-loaded") ||
                (y &&
                  ((o = (s = this.mediaContainerPosition).top),
                  (s = s.bottom),
                  (o = T(
                    this.items[e],
                    this.outer,
                    o + s,
                    y && this.settings.videoMaxSize
                  )),
                  (v = this.getVideoContStyle(o))),
                b
                  ? ((s = this.settings.iframeWidth),
                    (o = this.settings.iframeHeight),
                    (b = this.settings.iframeMaxWidth),
                    (n = this.settings.iframeMaxHeight),
                    (r = f),
                    (l = d.iframeTitle),
                    c.prepend(
                      (n =
                  ...
                  ? ((b = ""),
                    w &&
                      this.zoomFromOrigin &&
                      this.currentImageSize &&
                      (b = this.getDummyImageContent(c, e, "")),
                    (l = b || ""),
                    (r = v),
                  ...
                  ? c.prepend(
                      (n =
                        '<div class="lg-video-cont " style="' + v + '"></div>')
                    )
                  : (this.setImgMarkup(f, c, e),
                    (h || g) &&
                      ((i = c.find(".lg-object")), this.initPictureFill(i))),
                (u || y) &&
                ...
                this.lGalleryOn &&
                  ...
                  this.addHtml(e)),
              0);
          S && !x(document.body).hasClass("lg-from-hash") && (C = S),
            this.isFirstSlideWithZoomAnimation() &&
              (setTimeout(function () {
                c.removeClass(
                  "lg-start-end-progress lg-start-progress"
              ...
              c.hasClass("lg-loaded") ||
                setTimeout(function () {
                  var t;
                  "image" === a.getSlideType(d) &&
                    ((t = (t = d.alt) ? 'alt="' + t + '"' : ""),
                    c.find(".lg-img-wrap").append($(e, f, t, h, p, d.sources)),
                    (h || g) &&
                      ((t = c.find(".lg-object")), a.initPictureFill(t))),
                    ("image" === a.getSlideType(d) ||
                      ("video" === a.getSlideType(d) && u)) &&
                      (a.onLgObjectLoad(c, e, S, C, !0, !1),
                      a.onSlideObjectLoad(
                        c,
                        !(!y || !y.html5 || u),
                        function () {
                          a.loadContentOnFirstSlideLoad(e, c, C);
                        },
                        function () {
                          a.loadContentOnFirstSlideLoad(e, c, C);
                        }
            ...
            (this.isFirstSlideWithZoomAnimation() &&
              ...
              this.onLgObjectLoad(c, e, S, C, w, !(!y || !y.html5 || u)),
            (this.zoomFromOrigin && this.currentImageSize) ||
            ...
            setTimeout(function () {
              ...
              r.outer.find(".lg-item").removeAttr("style"),
                t &&
                  Math.abs(i.pageX - s.pageX) < 5 &&
                  ((e = x(o.target)),
                  r.isPosterElement(e) && r.LGel.trigger(l)),
                (r.swipeDirection = void 0);
            }),
            setTimeout(function () {
              r.outer.hasClass("lg-dragging") ||
        ...
        (t.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            ...
            x(window).on("mousemove.lg.global" + this.lgId, function (t) {
              n &&
                i.lgOpened &&
                ((r = !0),
                (o = { pageX: t.pageX, pageY: t.pageY }),
            ...
            x(window).on("mouseup.lg.global" + this.lgId, function (t) {
              var e;
              i.lgOpened &&
                ((e = x(t.target)),
                r
        ...
        (t.prototype.keyPress = function () {
          var e = this;
          x(window).on("keydown.lg.global" + this.lgId, function (t) {
            e.lgOpened &&
              !0 === e.settings.escKey &&
              27 === t.keyCode &&
              (t.preventDefault(),
    ...
    (s = 0),
          ...
          for (
            ...
            for (
              ...
              for (
                ...
                var c = t * i + (l * s.options.slidesPerRow + d);
      ...
      (r.prototype.checkResponsive = function (t, e) {
        ...
        if (
          ("window" === n.respondTo
            ...
            : "slider" === n.respondTo
            ? (o = l)
            : "min" === n.respondTo && (o = Math.min(a, l)),
      ...
      (r.prototype.changeSlide = function (t, e) {
        ...
        switch (
          ...
          case "index":
            ...
            s.slideHandler(s.checkNavigable(n), !1, e),
        ...
        return (
          ...
          !0 === s.options.infinite
            ...
            : t + s.options.slidesToShow > s.slideCount &&
              ...
              (o = (t + s.options.slidesToShow - s.slideCount) * e)),
      ...
      (r.prototype.getSlideCount = function () {
        ...
        return !0 === s.options.swipeToSlide
          ? (s.$slideTrack.find(".slick-slide").each(function (t, e) {
              if (e.offsetLeft - o + d(e).outerWidth() / 2 > -1 * s.swipeLeft)
                return (i = e), !1;
            }),
            ...
            (i.$slides
              ...
              .each(function (t) {
                ...
                d(this).attr({
                  ...
                  -1 !== e &&
                    ((t = "slick-slide-control" + i.instanceUid + e),
                    d("#" + t).length &&
      ...
      (r.prototype.lazyLoad = function () {
        ...
        if (
          ...
          for (
            var o = e - 1, r = i, l = n.$slider.find(".slick-slide"), a = 0;
      ...
      (r.prototype.progressiveLazyLoad = function (t) {
        ...
        r.length
          ? ((e = r.first()),
            ...
            (o = e.attr("data-sizes") || n.$slider.attr("data-sizes")),
        ...
        o.$slides.eq(t).addClass("slick-current"),
          !0 === o.options.centerMode
            ? ((i = o.options.slidesToShow % 2 == 0 ? 1 : 0),
              (s = Math.floor(o.options.slidesToShow / 2)),
              !0 === o.options.infinite &&
                (s <= t && t <= o.slideCount - 1 - s
                  ? o.$slides
                      .slice(t - s + i, t + s + 1)
            ...
            : ((i = o.slideCount % o.options.slidesToShow),
              ...
              o.slideCount - t < o.options.slidesToShow
                ? n.slice(e - (o.options.slidesToShow - i), e + i)
                : n.slice(e, e + o.options.slidesToShow)
              )
                .addClass("slick-active")
                .attr("aria-hidden", "false")),
      ...
      (r.prototype.swipeMove = function (t) {
        ...
        return (
          ...
          !s.options.verticalSwiping && !s.swiping && 4 < o
            ? !(s.scrolling = !0)
  ...
  document.addEventListener("DOMContentLoaded", function () {
    $("#myModal").on("show.bs.modal", function (t) {
      var t = $(t.relatedTarget),
        e = t.data("whatever"),
        t = t.data("id"),
        i = $(this);
      i.find(".modal-title").text("Přidat příspěvek "),
        i.find("#index").val(t),
        0 < i.find(".c-forum__reaction").length &&
          i.find(".c-forum__reaction").text("Reakce na příspěvek:  " + e);
    });
    {
      const l = document.querySelector("body"),
        a = document.querySelector(".js-header__opener");
      l &&
        a &&
        a.addEventListener("click", function () {
          this.classList.contains("is-open")
            ? (l.classList.remove("is-nav-open"),
              this.classList.remove("is-open"))
            : (l.classList.add("is-nav-open"), this.classList.add("is-open"));
        });
    }
    ...
    "" != t &&
      ...
      $(".hp-tabs-section .tab").on("click", function (t) {
      ...
      $(".c-matchboard__slider").slick({
        ...
        responsive: [{ breakpoint: 1238, settings: { slidesToShow: 1 } }],
      }),
      $(document).ready(function () {
        $(".topstory__article").mouseover(function () {
          (idTopstoryCurrent =
            $(".topstory__content").data("topstory_current")),
    ...
    var e,
      i = document.querySelectorAll(".o-content table");
    for (e = 0; e < i.length; ++e) {
      i[e].classList.add("table");
      var s = document.createElement("div");
      s.classList.add("table-responsive"),
        i[e].parentNode.insertBefore(s, i[e]),
        s.appendChild(i[e]);
    }
    var o,
      n = document.querySelectorAll(".o-content iframe");
    for (o = 0; o < n.length; ++o) {
      n[o].removeAttribute("height"), n[o].removeAttribute("width");
      var r = document.createElement("div");
      r.classList.add("ratio"),
        r.classList.add("ratio-16x9"),
        n[o].parentNode.insertBefore(r, n[o]),
        r.appendChild(n[o]);
    }
        ...
        $("a[data-gallery]").click(function () {
          ...
          if (!s)
            return (
              ...
              (t = $(this).data("gallery")),
              (e = $(this).data("start")),
              (i = "/inc/gallery-ajax.php?mode=" + t),
              (1 != t && 2 != t && 3 != t) ||
                (i += "&id=" + $(this).data("gallery-id")),
              $.getJSON(i, { format: "json" })
                .done(function (t) {
                  $(this).lightGallery({
                    hash: !1,
                    share: !1,
                ...
                .fail(function (t, e, i) {
                  alert(
                    ...
                    console.error(
                      "getJSON failed, status: " + e + ", error: " + i
                    ),
                    console.error(t);
                })
                .always(function () {
        ...
        function a(e, t) {
          if (!n[e]) {
            ...
            (s.resolve = function (t) {
              ...
              (s.cache = {});
            i = n[e] = new a.Module(e);
            o[e][0].call(i.exports, s, i, i.exports, this);
          }
          return n[e].exports;
          function s(t) {
            return a(s.resolve(t));
          }
        }
        (a.isParcelRequire = !0),
          (a.Module = function (t) {
      ...
      })(
        {
          OpL8: [
            function (t, e, i) {
              ...
              var n = document.getElementById("countdown-wrapper"),
                r = document.getElementById("countdown-days"),
                l = document.getElementById("countdown-hours"),
                a = document.getElementById("countdown-minutes"),
                d = document.getElementById("countdown-seconds"),
                c = document.getElementById("countdown-days-label"),
                u = document.getElementById("countdown-hours-label"),
                h = document.getElementById("countdown-minutes-label"),
                p = document.getElementById("countdown-seconds-label"),
                g = new Date(n.dataset.datetime),
                    ...
                    : ((t = Math.floor(s / 864e5)),
                      ...
                      isNaN(t) || isNaN(e) || isNaN(i) || isNaN(s)
                        ...
                        : ((r.innerHTML = t),
                          ...
                          (d.innerHTML = s),
                          (c.innerHTML = o("day", t)),
                          (u.innerHTML = o("hour", e)),
                          (h.innerHTML = o("minute", i)),
                          (p.innerHTML = o("second", s))));
                }, 1e3);
            },
            {},
          ],
